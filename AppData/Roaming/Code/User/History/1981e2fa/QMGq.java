...
//initialize the board
        ...
        while (!gameover) {
            ...
            String currentplay  =  (player == 'X') ? player1 : player2; //Get current player name
            System.out.println(currentplayer + " s turn to play ( " + play er + ")");  //
...
//che
        ...
        //check columns
        fo r (int col = 0; col < board[0].length; col++) {
